    ...
    try:  
        ...
        if len(df.index>0):
            ...
            if (to_lang=='en'):
                ...
                col1, col2, col3, col4, col6 = st.columns([1, 2, 2, 2, 2])
                with col1:
                    st.write("Number")
                with col2:
                    st.write("Word")
                ...
                for i in range(len(df.index)):
                    ...
                    with col4:  
                        text = translator.translate(word, src=lang, dest=english_to_lang)
                ...
                col1, col2, col4, col5, col6 = st.columns([1, 2, 2, 2, 2])
                with col1:
                    st.write("Number")
                with col2:
                    st.write("Word")
