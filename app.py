...
def main():
    ...
    subheader_templ = """
    <div>
    <h3>Save and Play MP3 of your favourite Articles!</h3>
    </div>
    """
    ...
    activity = ["Your sentence", "Wikipedia","Play Audio", "Email", "About"]
